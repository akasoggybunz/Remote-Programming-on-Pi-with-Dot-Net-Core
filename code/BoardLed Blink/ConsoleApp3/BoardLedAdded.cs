...
// This is my Added Implementation of Iot/devices/BoardLed because I was unable to get this references to work.
...
{
    class BoardLedAdded : IDisposable
    {
        ...
        public BoardLedAdded(string name)
        {
            Name = name;
        ...
        public static IEnumerable<BoardLedAdded> EnumerateLeds()
        {
            ...
            return infos.Where(x => x.EnumerateFiles().Select(f => f.Name).Contains("brightness"))
                .Select(x => new BoardLedAdded(x.Name));
        }
